...
const steps = [
  {
    ...
    visual: (
      <div className="font-mono text-center space-y-2">
        ...
        <p className="text-4xl font-bold">1.3520</p>
  ...
  },
  {
    ...
    visual: (
      <div className="font-mono text-center space-y-2">
        ...
        <p className="text-4xl font-bold">1.3858</p>
        <div className="flex items-center justify-center gap-2 text-blood">
    ...
    visual: (
      <div className="font-mono text-center space-y-3">
        <div className="flex justify-between text-sm border-b border-border pb-2">
          ...
          <span className="text-blood">$338.00</span>
        </div>
        <div className="flex justify-between text-sm border-b border-border pb-2">
          <span className="text-text-dim">Wire fee (sending)</span>
          <span className="text-blood">$40.00</span>
        </div>
        <div className="flex justify-between text-sm border-b border-border pb-2">
          <span className="text-text-dim">Wire fee (receiving)</span>
          <span className="text-blood">$15.00</span>
        </div>
        <div className="flex justify-between text-sm font-bold">
          <span>Total hidden cost</span>
          <span className="text-blood">$393.00</span>
        </div>
      </div>
    ),
  },
      ...
      <div className="font-mono text-center space-y-3">
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <p className="text-2xl font-bold text-blood">$3,930</p>
          </div>
          <div>
            <p className="text-text-dim">Annually</p>
            <p className="text-2xl font-bold text-blood">$47,160</p>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            How banks <span className="text-blood">rob you</span> on every transaction.
          </h2>
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className={i % 2 === 1 ? "md:order-2" : ""}>
                <span className="text-blood font-mono text-sm">{step.num}</span>
                <h3 className="text-xl font-bold mt-1 mb-3">{step.title}</h3>
                <p className="text-text-muted leading-relaxed">{step.desc}</p>
              </div>
              <div className={`bg-surface-light border border-border rounded-xl p-6 ${i % 2 === 1 ? "md:order-1" : ""}`}>
                {step.visual}
              </div>
            </motion.div>
          ))}
        ...
        >
          <a href="#tool" className="inline-flex items-center gap-2 text-blood hover:text-blood-light transition-colors font-medium">
