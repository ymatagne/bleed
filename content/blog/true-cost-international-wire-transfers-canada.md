---
title: "The True Cost of International Wire Transfers for Canadian Businesses"
description: "International wire transfers hit Canadian businesses with a double fee: the wire charge you see and the FX markup you don't. Here's what they really cost."
keywords: ["wire transfer FX markup canada", "international payments fees canada", "cross-border payment fees canadian banks", "international wire transfer cost"]
date: 2026-03-10
author: Loop Financial
slug: true-cost-international-wire-transfers-canada
---
...
1. **The wire transfer fee** — a flat fee per transaction ($30–$80 at most Big Five banks)
2. **The FX markup** — a percentage spread between the mid-market rate and your bank's rate (typically 1.5%–3%)
...
| Bank | Standard Wire Fee | Online Wire Fee |
|---|---|---|
| RBC | $45–$80 | $35–$45 |
| TD | $30–$80 | $30–$40 |
| BMO | $30–$45 | $25–$35 |
| Scotiabank | $35–$50 | $30–$40 |
| CIBC | $25–$40 | $25–$30 |
...
For a detailed comparison of bank FX spreads, see our [BMO vs Scotiabank vs CIBC comparison](/blog/bmo-vs-scotiabank-vs-cibc-business-fx-rates).
...
**FX markup doesn't appear on statements.** Your bank shows the exchange rate used and the resulting amount. It doesn't show the mid-market rate or the spread. To understand how this opacity works, read our explainer on [mid-market rate vs bank rate](/blog/mid-market-rate-vs-bank-rate-fx-spread).
...
We compare all of these options in our [best FX alternatives guide](/blog/best-fx-alternatives-canadian-businesses-2026).

## How to Audit Your Wire Transfer Costs

The first step is quantifying the problem:

1. Pull 6 months of bank statements
2. List every outgoing international wire with the amount, currency, and exchange rate used
3. Look up the mid-market rate for each transaction date
4. Calculate the spread on each transaction
5. Add up the total FX markup + wire fees

The result will be your true cost of international payments. It's almost always higher than people expect.

**Don't want to do this manually?** **[Loop's free FX audit](/audit)** calculates your total wire transfer costs — including hidden FX markup — automatically.
...
**[Run your free FX audit → See your real wire transfer costs](/audit)**
